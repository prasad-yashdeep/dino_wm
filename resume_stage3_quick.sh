...
################################################################################
# RESUME STAGE 3 QUICK TRAINING
################################################################################
# Resumes stage3_quick training from epoch 67 → 90 (23 remaining epochs)
################################################################################
...
# Training hyperparameters (matching train_3stage_quick.sh)
STATE_CODEBOOK_SIZE=64  # Quick run uses 64 state codes
...
# Remaining epochs (stopped at 67, target 90)
REMAINING_EPOCHS=23

echo ""
echo "========================================================================"
echo "▶️  RESUMING: STAGE 3 QUICK TRAINING"
echo "========================================================================"
echo "Checkpoint: $CHECKPOINT_DIR"
echo "Current epoch: 67"
echo "Target epoch: 90"
echo "Remaining epochs: $REMAINING_EPOCHS"
echo "Log file: $LOG_DIR/stage3_quick_resume.log"
echo "========================================================================"
echo ""
...
$PYTHON train.py \
    ...
    2>&1 | tee $LOG_DIR/stage3_quick_resume.log

echo ""
echo "✅ STAGE 3 QUICK TRAINING COMPLETED!"
echo ""
